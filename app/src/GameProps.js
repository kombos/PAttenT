    ...
    render() {
        ...
        return (
            <div className={classes.flexContainer}>
                <div className={classNames(classes.flexChild, classes.smallText)} style={{
                    textAlign: 'left',
                }}>
                    <span className={classes.largeText}>{"Round : " + currentRoundText}</span><br />
                    {"GameID : " + gameID}<br />
                </div>
                <div className={classes.flexChild} style={{
                    margin:'auto',
                    textAlign:'center',
                    //alignItems: 'flex-end',
                ...
                <div className={classNames(classes.flexChild, classes.smallText)} style={{
                    ...
                    {"Total Plays : " + (web3.utils.fromWei((parseInt(totalValueForGame)).toString(), 'ether') + " eth")}<br></br>
                    {"Total Wins : " + (web3.utils.fromWei((parseInt(totalWinnings)).toString(), 'ether') + " eth")}
                </div>
            </div>
        );
    }
