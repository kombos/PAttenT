    ...
    if (network == "ganache") {
        ...
        deployer.deploy(Multiprizer, { gas: 10000000 })
            ...
            .then(function (receipt) {
                ...
                return multiprizerInstance.completeRoundByAdmin(102, { from: accounts[0] });
            })
            .then(function (receipt) {
                console.log("complete round for current game ..... ");
                return multiprizerInstance.completeRoundByAdmin(103, { from: accounts[0] });
            })
            .then(function (receipt) {
                console.log("complete round for current game ..... ");
                return multiprizerInstance.completeRoundByAdmin(104, { from: accounts[0] });
            })
            .then(function (receipt) {
                console.log("complete round for current game ..... ");
                return multiprizerInstance.completeRoundByAdmin(105, { from: accounts[0] });
            })
            .then(function (receipt) {
                console.log("enable megaprize ..... ");
                return multiprizerInstance.unlockMegaPrizeByAdmin({ from: accounts[0] });
            })
            .then(function (receipt) {
